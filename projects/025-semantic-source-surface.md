...
> 本项目全部验收门已过。**
>
> 规范性依据：[Reference 011](../references/011-language-as-first-class.md)、
> [Reference 012](../references/012-defining-structures-axioms-and-proofs.md)、
> [Reference 013](../references/013-proof-api-for-verification-construction-search-and-exchange.md)、
> [术语规范 000](../references/000-terminology.zh.md)。
>
> 上游项目：[Project 024](024-first-class-language-refactor.md)（语义内核，已到 Phase 5E）。
