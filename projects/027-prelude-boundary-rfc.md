...
>
> 发布拓扑更新（[Project 028](028-top-level-knowledge-release-units.md)，
...
[Project 028](028-top-level-knowledge-release-units.md) 取代本节此前的包结构草图。
生效的 V1 拓扑是：
...
- [Project 028](028-top-level-knowledge-release-units.md) 取代旧发布拓扑：
...
- 2026-07-19：**三次裁决（定位收敛）**。prelude 维持现状极小
  ...
  单位、profile 机制）保持冻结。
- 2026-07-20：[Project 028](028-top-level-knowledge-release-units.md)
