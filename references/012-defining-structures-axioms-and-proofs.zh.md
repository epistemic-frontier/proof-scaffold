...
本文是 [Reference 011：将语言作为第一类元素](011-language-as-first-class.zh.md) 的作者实践规范，
并以 [Project 024：First-Class Language Refactor](../projects/024-first-class-language-refactor.zh.md)
